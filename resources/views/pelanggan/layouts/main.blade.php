...
<link href="{{ asset("https://fonts.googleapis.com/css2?family=Chilanka&family=Montserrat:wght@300;400;500&display=swap") }}"
  rel="stylesheet">
...
<body>
  ...
  @include('pelanggan.partials.cart')

  @include('pelanggan.partials.search')

  @include('pelanggan.partials.header')

  @include('pelanggan.partials.banner')

  @include('pelanggan.partials.categories')
